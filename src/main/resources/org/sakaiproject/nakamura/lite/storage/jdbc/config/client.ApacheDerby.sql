...
block-find = select TR.rid from (select distinct a.rid, ROW_NUMBER() OVER () AS R from css_b a {0} where {1} 1 = 1 {2}) as TR where TR.R > {4} and TR.R <= {3}+{4};, css {0} ; {0}.cid = ? and {0}.v = ? and {0}.rid = a.rid ; {0}.cid = ? and {0}.rid = a.rid ; order by {0}.v {1}
block-find.n.au = select TR.rid from (select distinct a.rid, ROW_NUMBER() OVER () AS R from au_css_b a {0} where {1} 1 = 1 {2}) as TR where TR.R > {4} and TR.R <= {3}+{4};, au_css {0} ; {0}.cid = ? and {0}.v = ? and {0}.rid = a.rid ; {0}.cid = ? and {0}.rid = a.rid ; order by {0}.v {1}
block-find.n.ac = select TR.rid from (select distinct a.rid, ROW_NUMBER() OVER () AS R from ac_css_b a {0} where {1} 1 = 1 {2}) as TR where TR.R > {4} and TR.R <= {3}+{4};, ac_css {0} ; {0}.cid = ? and {0}.v = ? and {0}.rid = a.rid ; {0}.cid = ? and {0}.rid = a.rid ; order by {0}.v {1}
block-find.n.cn = select TR.rid from (select distinct a.rid, ROW_NUMBER() OVER () AS R from cn_css_b a {0} where {1} 1 = 1 {2}) as TR where TR.R > {4} and TR.R <= {3}+{4};, cn_css {0} ; {0}.cid = ? and {0}.v = ? and {0}.rid = a.rid ; {0}.cid = ? and {0}.rid = a.rid ; order by {0}.v {1}
