...
public class Permissions {
	...
	public static final Permission CAN_READ = new Permission(0x0001, "Read ACL");
	public static final Permission CAN_WRITE = new Permission(0x0002, "Write ACL");
	public static final Permission CAN_DELETE = new Permission(0x0003, "Delete ACL");
	...
	public static final Permission CAN_ANYTHING_ACL = CAN_READ_ACL.combine(CAN_WRITE_ACL).combine(CAN_DELETE_ACL);
