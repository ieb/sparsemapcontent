  ...
  public void activate(Map<String, Object> properties) throws ClassNotFoundException {
    ...
    try {
      ...
      if (client == null) {
        ...
        Map<String, Object> cacheProperties = client.get(PROPERTIES_KEYSPACE,
            INDEX_COLUMN_FAMILY, ROW_OF_PROPERTIES);

        // If not stored, store default values.
        if (cacheProperties == null) {
          client.insert(PROPERTIES_KEYSPACE, INDEX_COLUMN_FAMILY, ROW_OF_PROPERTIES,
              ImmutableMap.of(PROPERTIES_INDEX_COLUMN_NAME,
                  (Object) (new ConfigurationImpl().getPropertiesIndexColumnName())),
              true);
        }
      }
