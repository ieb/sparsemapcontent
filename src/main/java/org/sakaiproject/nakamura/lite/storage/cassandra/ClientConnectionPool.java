...
public class ClientConnectionPool implements ConnectionPool {
	...
	public class ClientConnectionPoolFactory extends BasePoolableObjectFactory {
		...
		public Object makeObject() throws Exception {
			...
			ClientConnection clientConnection = new ClientConnection(tProtocol,
					tSocket);
	...
	public void activate(ComponentContext componentContext) {
		...
		long timeBetweenEvictionRunsMillis = (Long) properties.get(TIME_BETWEEN_EVICTION_RUNS_MILLIS);
		...
		pool = new GenericObjectPool(new ClientConnectionPoolFactory(
				connections), maxActive, whenExhaustedAction, maxWait, maxIdle,
	...
	/* (non-Javadoc)
	 * @see org.sakaiproject.nakamura.lite.cassandra.ConnectionPool#openConnection()
	 */
	public ClientConnection openConnection() throws ConnectionPoolException {
		try {
			...
			throw new ConnectionPoolException(
					"Failed To Borrow connection from pool ", e);
		}
	}

	/* (non-Javadoc)
	 * @see org.sakaiproject.nakamura.lite.cassandra.ConnectionPool#closeConnection()
	 */
	public void closeConnection() throws ConnectionPoolException {
		...
		if (clientConnection == null) {
			try {
				...
				throw new ConnectionPoolException(
						"Failed To Return connection to pool ", e);
			} finally {
