...
public class FsDirectoryResource extends FsReadOnlyDirectoryResource implements
		MakeCollectionableResource, PutableResource, CopyableResource,
		DeletableResource, MoveableResource, PropFindableResource,
		LockingCollectionResource, GetableResource, FsWritableResource {
	...
	public CollectionResource createCollection(String name) {
		...
		return new FsDirectoryResource(host, factory, fnew, ssoPrefix);
	}
