...
public class SparseIndexingServiceImpl implements IndexingHandler {
  ...
  public void activate(Map<String, Object> properties) {
    ...
    topics = Utils.get(properties.get(PROP_TOPICS), StoreListener.DEFAULT_TOPICS);
  ...
  public Collection<InputDocument> getDocuments(RepositorySession repositorySession, Event event) {
    ...
    if (topic.endsWith(StoreListener.UPDATED_TOPIC) || topic.endsWith(StoreListener.ADDED_TOPIC)) {
      ...
      if (!ignore(path)) {
        ...
        Collection<InputDocument> docs = getHandler(repositorySession, path)
  ...
  private void addDefaultFields(InputDocument doc, RepositorySession repositorySession) throws StorageClientException {
